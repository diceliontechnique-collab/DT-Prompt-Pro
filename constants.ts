...
const AR_LONG_DESCRIPTORS: Record<string, string[]> = {
  ...
  'طب': ["دليل طبي شامل يقدم نصائح صحية للوقاية من الأمراض بأسلوب مبسط وواضح"],
...
/* V64.0 HUMAN-DESCRIPTIVE ANATOMY SYSTEM (8-10 WORDS PER TITLE) */
