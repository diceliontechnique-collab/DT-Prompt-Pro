...
/* V170.0 INFOGRAPHIC SYSTEM DATA (5000 ITEMS) */
const INFOGRAPHIC_TEMPLATES = [
  "انفوجرافيك يشرح مراحل تطور التكنولوجيا في القرن العشرين بأسلوب بصري جذاب",
  "انفوجرافيك تفاعلي عن أهمية الغذاء الصحي وتأثيره على نشاط الجسم اليومي",
  "انفوجرافيك احترافي يوضح إحصائيات نمو التجارة الإلكترونية في الشرق الأوسط",
  "انفوجرافيك تعليمي عن دورة حياة النجوم من الولادة حتى الانفجار العظيم",
  "انفوجرافيك مبسط يوضح خطوات تأسيس شركة ناشئة ناجحة من الفكرة إلى التمويل",
  "انفوجرافيك رياضي عن فوائد التمارين الهوائية في تحسين صحة القلب والرئتين",
  "انفوجرافيك تقني يوضح بنية شبكة الجيل الخامس 5G ومميزاتها الخارقة",
  "انفوجرافيك تاريخي عن أهم الاختراعات التي غيرت مجرى البشرية بوضوح",
  "انفوجرافيك مالي يوضح طرق الادخار والاستثمار الذكي للأفراد في الأزمات",
  "انفوجرافيك بيئي عن أسباب الاحتباس الحراري وطرق الحد من انبعاث الكربون",
  "انفوجرافيك معماري يوضح أشهر ناطحات السحاب في العالم ومواصفاتها الهندسية",
  "انفوجرافيك طبي يوضح أعراض نقص الفيتامينات الأساسية ومصادرها الطبيعية",
  "انفوجرافيك سياحي عن أفضل الوجهات العالمية في فصل الشتاء مع التكاليف",
  "انفوجرافيك تسويقي عن سيكولوجية الألوان وتأثيرها على قرارات الشراء",
  "انفوجرافيك فضائي يوضح مكونات نظامنا الشمسي والمسافات بين الكواكب",
  "انفوجرافيك قانوني يبسط حقوق المستهلك في القوانين الدولية بوضوح",
  "انفوجرافيك تقني عن مراحل تطوير تطبيقات الهواتف الذكية من التصميم للكود",
  "انفوجرافيك تربوي عن أفضل طرق المذاكرة الفعالة وتحسين الذاكرة للطلاب",
  "انفوجرافيك إداري يوضح مهارات القيادة الحديثة في بيئة العمل الرقمية",
  "انفوجرافيك زراعي عن تقنيات الزراعة المائية وفوائدها في توفير المياه"
];

export const INFOGRAPHIC_OPTIONS = (() => {
  const list = ["بدون"];
  for(let i=1; i<=5000; i++) {
    const template = INFOGRAPHIC_TEMPLATES[i % INFOGRAPHIC_TEMPLATES.length];
    list.push(`${i} – ${template}`);
  }
  return list;
})();
...
export const getMillionthNeuralPrompt = (id: number, topic: string) => {
    ...
    // V64.0: Optimized Title Format [ID] - [Description 8-10 words]
